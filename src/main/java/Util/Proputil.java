...
public class Proputil {
	...
	public static String getvalueFromOr(String filePath, String key) {
	 ...
	 **/
	public static String getObjectFromRepo(String key) {
	 ...
	 * @return the locators value in form of {@code String}
	 **/
	public static String getUserAndPassword(String key) {
